...
export const Introduction = () => {
    return (
        <section className="section-block bg-bg text-primary transition-colors duration-300" id="introduction" data-section-title="introduction" data-toc-section="true">
            <div className="section-blocks relative bg-bg transition-colors duration-300">
                <section className="bg-bg p-4 heading-2 text-primary transition-colors duration-300 lg:p-6">
                    <p className="[&+&amp]:mt-[1em]">Built for busy households, Memo works 24/7 to make your life lighter. Hand off your repetitive to-do’s, so you can focus on what really matters.</p>
                </section>
                <section className="lg-px-6 grid grid-cols-1 gap-6 bg-bg px-4 py-24 text-primary transition-colors duration-300 md:grid-cols-12">
                    <div className="grid grid-cols-1 grid-rows-2 gap-6 rounded-xl border border-border p-3 sm:grid-cols-2 sm:grid-rows-1 md:col-span-10 md:col-start-2 lg:col-span-8 lg:col-start-3">
                        ...
                        <button className="group/button flex aspect-video cursor-pointer items-center justify-center overflow-hidden rounded-md bg-black dark">
                            ...
                            <VideoCOmp imageurl='/thumbnailpeople.webp' vdourl='/Sunday_Robotics___The_helpful_robotics_company (1).mp4' />
                        </button>
                    </div>
                </section>
            </div>
